...
#ifndef _aspect_postprocess_melt_emplacement_h
#define _aspect_postprocess_melt_emplacement_h
...
namespace aspect
{
  ...
  namespace Postprocess
  {
     ...
     */
    template <int dim>
    class MeltEmplacement : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
