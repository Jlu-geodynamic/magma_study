...
#ifndef _aspect_postprocess_melt_convey_4_h
#define _aspect_postprocess_melt_convey_4_h
...
namespace aspect
{
  ...
  namespace Postprocess
  {
     ...
     */
    template <int dim>
    class MeltConveyFour : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
