  ...
  namespace MeshRefinement
  {
      ...
      public SimulatorAccess<dim>
    {
      ...
      private:
         ...
         * overriding plate
         */
        std::vector<unsigned int> sed1_refinement;
        std::vector<unsigned int> sed2_refinement;
        std::vector<unsigned int> uc_refinement;
        std::vector<unsigned int> lc_refinement;
        std::vector<unsigned int> m_up_refinement;
		std::vector<unsigned int> m_mid_refinement;
		std::vector<unsigned int> m_low_refinement;
		std::vector<unsigned int> melt_refinement;
		std::vector<unsigned int> new_crust_refinement;
