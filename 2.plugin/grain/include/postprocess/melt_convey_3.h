...
#ifndef _aspect_postprocess_melt_convey_3_h
#define _aspect_postprocess_melt_convey_3_h
...
namespace aspect
{
  ...
  namespace Postprocess
  {
     ...
     */
    template <int dim>
    class MeltConveyThree : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
