...
#ifndef _aspect_heating_model_latent_heat_viscoplastic_melt_h
...
namespace aspect
{
  namespace HeatingModel
  {
     ...
     */
    template <int dim>
    class LatentHeatViscoPlasticMelt : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
      ...
      private:
        ...
        double mantle_melt_temp_reduction;
