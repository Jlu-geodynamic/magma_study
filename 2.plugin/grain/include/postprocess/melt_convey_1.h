...
#ifndef _aspect_postprocess_melt_convey_1_h
#define _aspect_postprocess_melt_convey_1_h
...
namespace aspect
{
  ...
  namespace Postprocess
  {
     ...
     */
    template <int dim>
    class MeltConveyOne : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
