...
#ifndef _aspect_material_model_rheology_dislocation_creep_grainsize_h
#define _aspect_material_model_rheology_dislocation_creep_grainsize_h
...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    namespace Rheology
    {
       ...
       */
      struct DislocationCreepGrainSizeParameters
      {
        /**
		...
		double water_exponent;
      };

      template <int dim>
      class DislocationCreepGrainSize : public ::aspect::SimulatorAccess<dim>
      {
        public:
          /**
           * Constructor.
           */
          DislocationCreepGrainSize();
